...
def calculator():
    global text_input, sin, cos, tan, log, ln, e, p,calc_operator, text_display, abs_value, modulo, int_div, factorial_button, eulers_num, sine, cosine, tangent, cotangent, pi_num, second_power, third_power, nth_power, inv_power, tens_powers, square_root, third_root, nth_root, log_base10, log_basee, left_par, right_par, signs, percentage, ex, button_0, button_1, button_2, button_3, button_4, button_5, button_6, button_7, button_8, button_9, delete_all, delete_one, mul, div, add, sub, point, exp, equal
    '''
    Variables
    '''
